...
class AccountControllerTest extends AbstractControllerTest {
    ...
    void register() throws Exception {
        ...
        UserTestUtil.assertEquals(registered, userRepository.findById(newId).orElseThrow(() -> new UsernameNotFoundException("User '" + newId + "' was not found")));
    }
    ...
    void update() throws Exception {
        ...
        perform(MockMvcRequestBuilders.put(URL)
                ...
                .andDo(print())
                .andExpect(status().isNoContent());
        UserTestUtil.assertEquals(updated, userRepository.findById(USER_ID).orElseThrow(() -> new UsernameNotFoundException("User '" + USER_ID + "' was not found")));
    }
}